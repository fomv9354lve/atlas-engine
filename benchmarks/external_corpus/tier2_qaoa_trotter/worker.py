...
JSON line. Isolated in its own process so a heavy contraction can be killed by a
timeout without taking down the whole corpus run. Calls cost_atlas directly
(research-only; the live web n-cap is untouched; nothing is deployed)."""
